      ...
      <div className={styles.mainBlock}>
        <div className={styles.row}>
          ...
          <section className={styles.benefits}>
            ...
            <ul className={styles.list}>
              ...
              <li className={styles.listItem}>
                Швидкий ремонт протягом 24 годин
              </li>
          ...
          <section className={styles.faq}>
            ...
            <div className={styles.faqItem}>
              ...
              <p>
                Зазвичай ремонт займає від 1 до 3 годин в залежності від
                складності проблеми.
              </p>
            </div>
            <div className={styles.faqItem}>
        ...
        <div className={styles.row}>
          <section className={styles.aboutUs}>
            <h2>Про нас</h2>
            <p>
              Наша компанія була заснована у 2010 році і за цей час ми стали
              одними з провідних постачальників послуг ремонту телефонів у
              Львові. Ми прагнемо забезпечити високоякісний сервіс для кожного
              клієнта.
            </p>
          </section>
